    ...
    <Box width={"100%"}>
      <Flex
        ...
        <Stack
          ...
          width={["100%", "100%", "100%", "38vw", "38vw"]}
          ml={["0vw", "0vw", "0vw", "10vw", "10vw"]}
          position={"relative"}
          top={["8vh", "8vh", "8vh", "0vh", "0vh"]}
          bottom={["0vh", "0vh", "0vh", "8vh", "8vh"]}
          right={["0vh", "0vh", "0vh", "7vh", "7vw"]}
          ...
          <Accordion width={["100%", "100%", "100%", "28vw", "28vw"]} defaultIndex={[0]} allowMultiple>
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                <VStack align={"start"}>
                  <Text fontSize={"13px"} color={"grey"}>Product id <span style={{ position: "relative", left: "5vw", color: "black" }}>152841</span></Text>
                  <Text fontSize={"13px"} color={"grey"}>Model No. <span style={{ position: "relative", left: "5vw", color: "black" }}>VC E14716</span></Text>
                  <Text fontSize={"13px"} color={"grey"}>Frame Size <span style={{ position: "relative", left: "5vw", color: "black" }}>{data.size}</span></Text>
                  <Text fontSize={"13px"} color={"grey"}>Frame Width <span style={{ position: "relative", left: "4vw", color: "black" }}>137 mm</span></Text>
                  <Text fontSize={"13px"} color={"grey"}>Frame Dimensions <span style={{ position: "relative", left: "2vw", color: "black" }}>53-18-135</span></Text>
                </VStack>
              </AccordionPanel>
            </AccordionItem>
